...
**Problem:** [1605C Dominant Character](https://codeforces.com/problemset/problem/1605/C)
...
The first line of each test case contains a single integer n (2 ≤ n ≤ 10^{6})  — the length of the string s.
